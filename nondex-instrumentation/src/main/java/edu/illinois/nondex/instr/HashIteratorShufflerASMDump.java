...
public class HashIteratorShufflerASMDump implements Opcodes {
    ...
    public static byte[] dump(String type) {
        ...
        }
        {
            ...
            mv.visitFieldInsn(Opcodes.GETFIELD, "java/util/HashMap$HashIterator", "initTraces", "Ljava/lang/String;");
            mv.visitFieldInsn(Opcodes.PUTFIELD, "java/util/HashMap$HashIterator$HashIteratorShuffler", "initTraces", "Ljava/lang/String;");
            mv.visitVarInsn(ALOAD, 3);
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETFIELD, "java/util/HashMap$HashIterator$HashIteratorShuffler", "initTraces",
                    "Ljava/lang/String;");
