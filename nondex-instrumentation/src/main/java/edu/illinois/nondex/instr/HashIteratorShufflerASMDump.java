...
public class HashIteratorShufflerASMDump implements Opcodes {
    ...
    public static byte[] dump (String type) {
        ...
        {
            fv = cw.visitField(ACC_PRIVATE, "iter", "Ljava/util/Iterator;", "Ljava/util/Iterator<Ljava/util/HashMap$"+type+"<TK;TV;>;>;", null);
            fv.visitEnd();
        }
        {
        ...
        {
            mv = cw.visitMethod(ACC_PUBLIC, "next"+type, "(I)Ljava/util/HashMap$"+type+";", "(I)Ljava/util/HashMap$"+type+"<TK;TV;>;", null);
            mv.visitCode();
